...
import (
	...
	"github.com/wfxiang08/thrift_rpc_base/tree/master/rpc_thriftrpc_thrift/services"
...
type Location struct {
  City string `thrift:"city,1" db:"city" json:"city"`
  Province string `thrift:"province,2" db:"province" json:"province"`
...
func (p *IpServiceClient) IpToLocation(ip string) (r *Location, err error) {
  if err = p.sendIpToLocation(ip); err != nil { return }
